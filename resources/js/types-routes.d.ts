...
declare namespace App {
  declare namespace Route {
    ...
    export type TypePost = App.Route.Typed.LoginPOST | App.Route.Typed.LogoutPOST | App.Route.Typed.ForgotPasswordPOST | App.Route.Typed.ResetPasswordPOST | App.Route.Typed.RegisterPOST | App.Route.Typed.UserConfirmPasswordPOST | App.Route.Typed.TwoFactorChallengePOST | App.Route.Typed.UserTwoFactorAuthenticationPOST | App.Route.Typed.UserConfirmedTwoFactorAuthenticationPOST | App.Route.Typed.UserTwoFactorRecoveryCodesPOST | App.Route.Typed.ApiSubmissionsPOST
